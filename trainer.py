# Benjamin Ramirez
# May 8, 2017
# modifying tensorflow's example for convolutional neural network model training with tf.layers
# to classify a different set of images/categories


###====================LICENSE FROM ORIGINAL CODE found here: =======================####
...
def cnn_model_fn(features, labels, mode):
  ...
  # My data set is 64x64 1 channel monochrome
  ...
  # Input Tensor Shape: [batch_size, 14 * 14 * 64]
  # Output Tensor Shape: [batch_size, 12544]
  dense = tf.layers.dense(inputs=pool2_flat, units=12544, activation=tf.nn.relu)
  ...
  # Logits layer
  # Input Tensor Shape: [batch_size, 12544]
  # Output Tensor Shape: [batch_size, NUM_CATEGORIES]
